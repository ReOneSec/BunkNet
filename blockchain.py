...
FAUCET_PRIVATE_KEY_HEX = environ.get('BUNKNET_FAUCET_PRIVATE_KEY')
...
# --- Faucet Wallet Setup ---
if FAUCET_PRIVATE_KEY_HEX:
    faucet_private_key = ecdsa.SigningKey.from_string(bytes.fromhex(FAUCET_PRIVATE_KEY_HEX), curve=ecdsa.SECP256k1)
    ...
    logging.warning("BUNKNET_FAUCET_PRIVATE_KEY not found. Faucet will be disabled.")
